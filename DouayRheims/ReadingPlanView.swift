...
enum ReadingPlan {
    ...
    private static func generatePlan() -> [DailyReading] {
        ...
        let bookChapters: [(String, Int)] = [
            ...
            ("Deuteronomy", 34), ("Josue", 24), ("Judges", 21), ("Ruth", 4),
            ("1 Kings", 31), ("2 Kings", 24), ("3 Kings", 22), ("4 Kings", 25),
            ("1 Paralipomenon", 29), ("2 Paralipomenon", 36), ("1 Esdras", 10), ("2 Esdras", 13),
            ("Tobias", 14), ("Judith", 16), ("Esther", 16), ("Job", 42),
            ("Psalms", 150), ("Proverbs", 31), ("Ecclesiastes", 12), ("Canticle of Canticles", 8),
            ("Wisdom", 19), ("Ecclesiasticus", 51), ("Isaias", 66), ("Jeremias", 52),
            ("Lamentations", 5), ("Baruch", 6), ("Ezechiel", 48), ("Daniel", 14),
            ("Osee", 14), ("Joel", 3), ("Amos", 9), ("Abdias", 1),
            ("Jonas", 4), ("Micheas", 7), ("Nahum", 3), ("Habacuc", 3),
            ("Sophonias", 3), ("Aggeus", 2), ("Zacharias", 14), ("Malachias", 4),
            ("1 Machabees", 16), ("2 Machabees", 15),
